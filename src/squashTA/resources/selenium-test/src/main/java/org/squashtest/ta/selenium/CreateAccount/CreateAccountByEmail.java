...
public class CreateAccountByEmail {
    ...
    @Test
    public  void testCreateAccountByEmail() throws Exception {
        ...
        driver.findElement(By.id("lastname")).sendKeys(cf.GetParameByName("in_last_name",id_test_case,dataset_name));
