...
public class Je_presente_ma_startup {
    ...
    @Test
    public void testJe_presente_ma_startup() throws Exception {
        ...
        //Assert.assertTrue(driver.findElement(By.id("newsletter_btn")).getText().equalsIgnoreCase("Je reste informé"));
        ...
        //Verification del la format date
        Assert.assertTrue((driver.findElement(By.cssSelector("body > div.container.clearfix > div > div.main > div.wrap > section.section_derniere_actus.animated_section.arrived_section > div > div.section_content > div > div > div > a.slide_item.slick-slide.slick-current.slick-active > div.slide_header > div > div")).getText()).matches(DATEREGEX));
        System.out.println("Verification de date done ");
        //Test of title assert that the title on challange page is the same as the title on challange selected
        Assert.assertTrue(driver.findElement(By.cssSelector("body > div.container.clearfix > div > div.main > div.wrap > section.section_derniere_actus.animated_section.arrived_section > div > div.section_content > div > div > div > a.slide_item.slick-slide.slick-current.slick-active > div.slide_header > h3")).isDisplayed());
        ...
        Assert.assertTrue(driver.findElement(By.cssSelector("body > div.container.clearfix > div > div.main > div.wrap > section.section_derniere_actus.animated_section.arrived_section > div > div.section_content > div > div > div > a:nth-child(2) > div.slide_header > div:nth-child(3) > span")).isDisplayed());
        System.out.println("Tag Done  ");
        Assert.assertTrue(driver.findElement(By.cssSelector("body > div.container.clearfix > div > div.main > div.wrap > section.section_derniere_actus.animated_section.arrived_section > div > div.section_content > div > div > div > a.slide_item.slick-slide.slick-current.slick-active > div.slide_footer > span")).isDisplayed());
        System.out.println("Decouverir button done ");
        // Verification de la page je presente ma start up apres click sur le button
